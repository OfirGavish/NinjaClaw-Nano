...
NinjaClaw gives you the core functionality without that mess.
...
I don't need an installation wizard - GitHub Copilot guides the setup. I don't need a monitoring dashboard - I ask GitHub Copilot what's happening. I don't need elaborate logging UIs - I ask Copilot to read the logs. I don't need debugging tools - I describe the problem and Copilot fixes it.
...
> **Note:** Telegram, Slack, Discord, Gmail, and Apple Container skills already exist. See the [skills documentation](https://docs.NinjaClaw.dev/integrations/skills-system) for the full list.
...
- Minimal glue code
- File-based systems where possible (COPILOT.md for memory, folders for groups)
...
### Memory System
- **Per-group memory**: Each group has a folder with its own `COPILOT.md`
- **Global memory**: Root `COPILOT.md` is read by all groups, but only writable from "main" (self-chat)
- **Files**: Groups can create/read files in their folder and reference them
- Agent runs in the group's folder, automatically inherits both COPILOT.md files
...
- Can write to global memory (`groups/COPILOT.md`)
...
- Custom `NinjaClaw` MCP server (inside container) provides scheduling tools
...
- Setup and customization done via GitHub Copilot
- Users clone the repo and run GitHub Copilot to configure
...
- `/update-NinjaClaw` - Pull upstream changes, merge with customizations
...
**NinjaClaw** - A reference to Clawdbot (now OpenClaw).
