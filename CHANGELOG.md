...
All notable changes to NinjaClaw will be documented in this file.

For detailed release notes, see the [full changelog on the documentation site](https://docs.NinjaClaw.dev/changelog).

## [1.2.36] - 2026-03-26

- [BREAKING] Replaced pino logger with built-in logger. WhatsApp users must re-merge the WhatsApp fork to pick up the Baileys logger compatibility fix: `git fetch whatsapp main && git merge whatsapp/main`. If the `whatsapp` remote is not configured: `git remote add whatsapp https://github.com/OfirGavish/NinjaClaw-Nano-whatsapp.git`.
...
- Added `/remote-control` command for host-level GitHub Copilot access from within containers
...
- Updated `Copilot-agent-sdk` to 0.2.68
...
- Added `/update-NinjaClaw` skill for syncing with upstream
...
- Added `/update` skill to pull upstream changes from within GitHub Copilot
- Enhanced container environment isolation via credential proxy
