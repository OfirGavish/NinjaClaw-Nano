...
This skill adds Slack support to NinjaClaw, then walks through interactive setup.
...
```bash
git remote add slack https://github.com/OfirGavish/NinjaClaw-Nano-slack.git
```
...
>
> The JID format for NinjaClaw is: `slack:C0123456789`
...
6. Restart: `launchctl kickstart -k gui/$(id -u)/com.NinjaClaw`
