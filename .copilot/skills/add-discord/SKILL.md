---
name: add-discord
description: Add Discord bot channel integration to NinjaClaw.
---

# Add Discord Channel

This skill adds Discord support to NinjaClaw, then walks through interactive setup.
...
```bash
git remote add discord https://github.com/OfirGavish/NinjaClaw-Nano-discord.git
```
...
4. Service is running: `launchctl list | grep NinjaClaw`
...
- @mention translation (Discord `<@botId>` → NinjaClaw trigger format)
