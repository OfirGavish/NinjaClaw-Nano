...
This is an idea file, designed to be copied to your own LLM Agent (e.g. OpenAI Codex, GitHub Copilot, OpenCode / Pi, etc.). Its goal is to communicate the high-level idea, with your agent building out specifics through collaboration with you.
...
**The schema** — configuration document (e.g., COPILOT.md) explaining wiki structure, conventions, and workflows for ingestion, querying, and maintenance. This key file transforms the LLM into disciplined wiki maintainer rather than generic chatbot.
