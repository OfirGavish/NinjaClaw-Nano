...
description: Add image vision to NinjaClaw agents. Resizes and processes WhatsApp image attachments, then sends them to Copilot as multimodal content blocks.
---

# Image Vision Skill

Adds the ability for NinjaClaw agents to see and understand images sent via WhatsApp. Images are downloaded, resized with sharp, saved to the group workspace, and passed to the agent as base64-encoded multimodal content blocks.
