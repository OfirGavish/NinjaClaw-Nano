...
This skill adds Telegram support to NinjaClaw, then walks through interactive setup.
...
```bash
git remote add telegram https://github.com/OfirGavish/NinjaClaw-Nano-telegram.git
```
...
- Check bot is started: `tail -f logs/NinjaClaw.log`
