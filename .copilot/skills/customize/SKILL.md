---
name: customize
description: Add new capabilities or modify NinjaClaw behavior. Use when user wants to add channels (Telegram, Slack, email input), change triggers, add integrations, modify the router, or make any other customizations. This is an interactive skill that asks questions to understand what the user wants.
---

# NinjaClaw Customization
...
| `groups/COPILOT.md` | Global memory/persona |
...
2. Document available tools in `groups/COPILOT.md`
...
Persona changes → edit `groups/COPILOT.md`
Per-group behavior → edit specific group's `COPILOT.md`
...
Implementation:
1. Commands are handled by the agent naturally — add instructions to `groups/COPILOT.md` or the group's `COPILOT.md`
